...
module.exports = "<div>{{texto}}</div>\n<button (click)=\"leerCookie()\">Leer cookie</button>\n"
...
/***/ "./src/app/components/usuario/usuario.component.sass":
/*!***********************************************************!*\
  !*** ./src/app/components/usuario/usuario.component.sass ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvdXN1YXJpby91c3VhcmlvLmNvbXBvbmVudC5zYXNzIn0= */"
...
var UsuarioComponent = /** @class */ (function () {
    function UsuarioComponent(CookieService) {
        this.CookieService = CookieService;
        this.texto = "hola";
    }
    UsuarioComponent.prototype.ngOnInit = function () {
    };
    UsuarioComponent.prototype.leerCookie = function () {
        this.cookieValue = this.CookieService.get('tg_user');
        if (this.cookieValue) {
            this.texto = "hacked";
        }
        else {
            this.texto = "No hay cookie";
        }
    };
    ...
    UsuarioComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./usuario.component.sass */ "./src/app/components/usuario/usuario.component.sass")]
        })
    ], UsuarioComponent);
...
module.exports = __webpack_require__(/*! /root/Web/panel/public/src/main.ts */"./src/main.ts");
