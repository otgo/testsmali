...
.method private checkForAllMandatoryFields(Lorg/json/JSONObject;Ljava/util/ArrayList;Lcom/supersonic/mediationsdk/config/ConfigValidationResult;)V
    ...
    invoke-static {v2, v4}, Lcom/supersonic/mediationsdk/utils/ErrorBuilder;->buildKeyNotSetForProviderError(Ljava/lang/String;Ljava/lang/String;)Lcom/supersonic/mediationsdk/logger/SupersonicError;
    ...
    invoke-direct {p0, v3}, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->isEmpty(Ljava/lang/String;)Z
...
.method private validateAllFields(Lorg/json/JSONObject;Lcom/supersonic/mediationsdk/config/ConfigValidationResult;)V
    ...
    invoke-virtual {p0, v3}, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->logConfigWarningMessage(Lcom/supersonic/mediationsdk/logger/SupersonicError;)V
...
.method protected getMaxVideosPerIterationToPresent()I
    ...
    .local v1, "result":I
    :try_start_0
    iget-object v2, p0, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->mJsonSettings:Lorg/json/JSONObject;
    ...
    .line 53
    .local v0, "maxVideosPerIteration":I
    move v1, v0

    .line 58
    .end local v0    # "maxVideosPerIteration":I
    :cond_0
    :goto_0
    return v1
...
.method protected getMaxVideosToPresent()I
    ...
    .line 71
    .local v0, "maxVideos":I
    move v1, v0

    .line 76
    .end local v0    # "maxVideos":I
    :cond_0
    :goto_0
    return v1
...
.method public validateOptionalKeys(Ljava/util/ArrayList;)V
    ...
    const-string v7, ":validateOptionalKeys(config: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->mJsonSettings:Lorg/json/JSONObject;
    ...
    new-instance v3, Lcom/supersonic/mediationsdk/config/ConfigValidationResult;

    invoke-direct {v3}, Lcom/supersonic/mediationsdk/config/ConfigValidationResult;-><init>()V

    .line 122
    .local v3, "result":Lcom/supersonic/mediationsdk/config/ConfigValidationResult;
    invoke-virtual {p1}, Ljava/util/ArrayList;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct {p0, v2}, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->isOptionalField(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v4, v2, v3}, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->validateOptionalField(Lorg/json/JSONObject;Ljava/lang/String;Lcom/supersonic/mediationsdk/config/ConfigValidationResult;)V
    ...
    invoke-virtual {p0, v4}, Lcom/supersonic/mediationsdk/config/AbstractAdapterConfig;->logConfigWarningMessage(Lcom/supersonic/mediationsdk/logger/SupersonicError;)V

    .line 127
    invoke-virtual {v3}, Lcom/supersonic/mediationsdk/config/ConfigValidationResult;->setValid()V
    ...
    const-string v7, ":validateOptionalKeys("
...
.method protected validateRewards(ILcom/supersonic/mediationsdk/config/ConfigValidationResult;)V
    ...
    const-string v3, "rewards value should be any positive value."
