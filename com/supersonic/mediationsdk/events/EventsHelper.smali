...
.method private constructor <init>()V
    ...
    .line 45
    const-string v0, "http://outcome.supersonicads.com/mediation/"
...
.method private addEvent(Lcom/supersonic/mediationsdk/events/Event;)V
    .locals 6
    .param p1, "event"    # Lcom/supersonic/mediationsdk/events/Event;
...
.method private shouldBackupEventsToDb(Ljava/util/ArrayList;)Z
    ...
    .prologue
    .line 305
    .local p1, "events":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/supersonic/mediationsdk/events/Event;>;"
    const/4 v0, 0x0
...
.method private shouldSendEvents(Lcom/supersonic/mediationsdk/events/Event;)Z
    .locals 2
    .param p1, "currentEvent"    # Lcom/supersonic/mediationsdk/events/Event;
...
.method public static declared-synchronized start(Landroid/content/Context;)Lcom/supersonic/mediationsdk/events/EventsHelper;
    ...
    .prologue
    .line 85
    const-class v2, Lcom/supersonic/mediationsdk/events/EventsHelper;

    monitor-enter v2

    :try_start_0
    sget-object v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;

    if-nez v1, :cond_0

    .line 86
    new-instance v1, Lcom/supersonic/mediationsdk/events/EventsHelper;

    invoke-direct {v1, p0}, Lcom/supersonic/mediationsdk/events/EventsHelper;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;

    .line 88
    :cond_0
    sget-object v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;

    sget-object v3, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v3, "http://outcome.supersonicads.com/mediation/"

    invoke-static {p0, v3}, Lcom/supersonic/mediationsdk/utils/SupersonicUtils;->getDefaultEventsURL(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mServerUrl:Ljava/lang/String;

    .line 92
    sget-object v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;

    iget-object v1, v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mDbHelper:Lcom/supersonic/mediationsdk/events/SupersonicDbHelper;
    ...
    new-instance v3, Lcom/supersonic/mediationsdk/events/SupersonicDbHelper;

    invoke-direct {v3, p0}, Lcom/supersonic/mediationsdk/events/SupersonicDbHelper;-><init>(Landroid/content/Context;)V

    iput-object v3, v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mDbHelper:Lcom/supersonic/mediationsdk/events/SupersonicDbHelper;
    ...
    .line 98
    .local v0, "generalPropertiesFromLastSession":Lorg/json/JSONObject;
    invoke-static {}, Lcom/supersonic/mediationsdk/events/SuperLooper;->getLooper()Lcom/supersonic/mediationsdk/events/SuperLooper;
    ...
    invoke-virtual {v1, v3}, Lcom/supersonic/mediationsdk/events/SuperLooper;->post(Ljava/lang/Runnable;)V
    ...
    new-instance v3, Lcom/supersonic/mediationsdk/utils/GeneralPropertiesWorker;

    invoke-direct {v3, p0}, Lcom/supersonic/mediationsdk/utils/GeneralPropertiesWorker;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v3}, Lcom/supersonic/mediationsdk/events/SuperLooper;->post(Ljava/lang/Runnable;)V

    .line 106
    .end local v0    # "generalPropertiesFromLastSession":Lorg/json/JSONObject;
    :cond_1
    sget-object v1, Lcom/supersonic/mediationsdk/events/EventsHelper;->mInstance:Lcom/supersonic/mediationsdk/events/EventsHelper;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized notifyGetInstanceEvent(Ljava/lang/String;)V
    ...
    .line 243
    .local v1, "event":Lcom/supersonic/mediationsdk/events/Event;
    ...
    .line 242
    .end local v1    # "event":Lcom/supersonic/mediationsdk/events/Event;
    :catchall_0
    move-exception v0
