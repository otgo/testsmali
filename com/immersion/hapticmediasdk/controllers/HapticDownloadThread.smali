...
.method public writeToFile(Ljava/io/InputStream;I)Z
    ...
    iget-object v5, p0, Lcom/immersion/hapticmediasdk/controllers/HapticDownloadThread;->c:Ljava/lang/String;

    invoke-virtual {v0, v5}, Lcom/immersion/hapticmediasdk/utils/FileManager;->makeOutputStreamForStreaming(Ljava/lang/String;)Ljava/io/BufferedOutputStream;
    :try_end_2
    ...
    invoke-virtual {v4, v7, v6}, Landroid/os/Bundle;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V
    ...
    invoke-virtual {v0, v5}, Lcom/immersion/hapticmediasdk/utils/FileManager;->closeCloseable(Ljava/io/Closeable;)V
    ...
    invoke-virtual {v0, v5}, Lcom/immersion/hapticmediasdk/utils/FileManager;->makeOutputStream(Ljava/lang/String;)Ljava/io/BufferedOutputStream;
    :try_end_f
    ...
    invoke-virtual {v4, v6, v3, v5}, Ljava/io/BufferedInputStream;->read([BII)I
    ...
    invoke-virtual {v0, v6, v5, v3}, Ljava/io/BufferedOutputStream;->write([BII)V
    ...
    invoke-virtual {v3, v5, v1, v7}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
